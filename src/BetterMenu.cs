...
namespace EnemyHPBar
{
    ...
    internal static class BetterMenu
    {
        ...
        {
            var skinToApply = EnemyHPBar.SkinList[selectedSkin];
        ...
        {
            return EnemyHPBar.SkinList.Select(s => HPBarList.MaxLength(s.GetName(), EnemyHPBar.instance.globalSettings.NameLength)).ToArray();
        }
        internal static Menu PrepareMenu()
        {
            
            return new Menu("EnemyHPBar", new Element[] {
        ...
        {
            selectedSkin = EnemyHPBar.SkinList.FindIndex(skin => skin.GetId() == skinId);
        }
        public static ISelectableSkin GetSkinById(string id)
        {
            return EnemyHPBar.SkinList.Find(skin => skin.GetId() == id) ?? GetDefaultSkin();
        }
